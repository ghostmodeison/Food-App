...
export default function AboutUs() {
  return (
    <div className="lg:flex space-y-6 my-40 p-10 w-2/3 mx-auto  justify-between text-4xl text-slate-500  ">
      ...
      <div className=" flex justify-center align-middle items-center my-48 space-y-5">
        <Section>
          <h1>
